...
function CreateInteractiveCanvas(x,y,w,h,source_container,source_container_FG){
	...
	var handleTex_rotations = [
		PIXI.Texture.fromImage("handle_rotate0.png",null,PIXI.SCALE_MODES.NEAREST),
		PIXI.Texture.fromImage("handle_rotate1.png",null,PIXI.SCALE_MODES.NEAREST),
		PIXI.Texture.fromImage("handle_rotate2.png",null,PIXI.SCALE_MODES.NEAREST),
		PIXI.Texture.fromImage("handle_rotate3.png",null,PIXI.SCALE_MODES.NEAREST),
	];

	var handleTex_scales = [
		PIXI.Texture.fromImage("handle_resize0.png",null,PIXI.SCALE_MODES.NEAREST),
		PIXI.Texture.fromImage("handle_resize1.png",null,PIXI.SCALE_MODES.NEAREST)
	];
	var handleTex_skew = PIXI.Texture.fromImage("skewhandle.png",null,PIXI.SCALE_MODES.NEAREST);
